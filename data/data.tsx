...
export const names = ["Արայիկ", "Էլեն"];
export const date = "26/06/2026";
export const txt1 =
  "Մեր սիրո պատմության\n նոր էջը սկսվում է,\n և մենք ուրախ կլինենք,\n եթե այդ օրը լինեք մեր կողքին։\nՍիրով հրավիրում ենք \nՁեզ մեր նշանադրությանը։";
