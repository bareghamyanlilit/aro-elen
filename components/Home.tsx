...
export function Home() {
  ...
  return (
    <div className="text-center overflow-hidden  FontSHK_Dzeragir ">
      ...
      <div className=" mt-30  w-full text-vrayi relative ">
      ...
      <motion.div {...anim} className="relative text-sovorakan  text-2xl my-10">
        ...
        <motion.div {...anim} className="px-5">
          <Image
            ...
            width={500}
            height={500}
            className="w-full mt-5 object-cover rounded-xl mb-20 "
          />
        </motion.div>
      </motion.div>
